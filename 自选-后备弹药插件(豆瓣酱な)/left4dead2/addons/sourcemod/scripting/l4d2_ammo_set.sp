...
public void OnConfigsExecuted()
{
	if(ammo_g_Switch_true)
	{
		switch(G_l4d2_ammo_set)
		{
			...
			{
				l4d2_hActive = false;
				l4d2_MoreOrInfiniteAmmo = false;
				l4d2_MoreAmmo = false;
			}
			case 1:
			{
				l4d2_MoreOrInfiniteAmmo = true;
				l4d2_MoreAmmo = true;
			}
			case 2:
			{
...
void l4d2_ammosetStartDelays_prompt()
{
	...
	{
		PrintToChatAll("\x04[提示]\x05已关闭\x03更多/无限\x05后备弹药.");
	}
}
