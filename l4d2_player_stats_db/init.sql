...
CREATE TABLE IF NOT EXISTS `t_player_connect_log` (
  ...
  `ip_country` varchar(64) NOT NULL DEFAULT '<N/A>' COMMENT 'IP country',
  `ip_region` varchar(64) NOT NULL DEFAULT '<N/A>' COMMENT 'IP region',
  `ip_city` varchar(64) NOT NULL DEFAULT '<N/A>' COMMENT 'IP city',
